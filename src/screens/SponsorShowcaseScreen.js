    ...
    if (sponsor.whatsapp) {
      try {
        ...
        if (match && match[1]) {
          ...
          const whatsappUrl = `whatsapp://send?phone=${numero}&text=Ol%C3%A1,%20participei%20do%20evento%20da%20IIMA%20e%20gostaria%20de%20saber%20mais%20sobre%20suas%20solu%C3%A7%C3%B5es.`;
